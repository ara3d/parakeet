...
namespace Parakeet.Cst.PlatoGrammarNameSpace
{
    /// <summary>
    /// Nodes = 
    /// </summary>
    public class CstArrayInitializationValue : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ArrayInitializationValue;
        public CstArrayInitializationValue(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstArraySizeSpecifier : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ArraySizeSpecifier;
        public CstArraySizeSpecifier(string text) : base(text) { }
        // No children
    }
    ...
    /// </summary>
    public class CstBinaryOperation : CstNode
    {
    ...
    /// Nodes = Statement
    /// </summary>
    public class CstCaseClause : CstNode
    {
    ...
    /// Nodes = TypeExpr
    /// </summary>
    public class CstCastExpression : CstNode
    {
    ...
    /// Nodes = 
    /// </summary>
    public class CstExpressionBody : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ExpressionBody;
        public CstExpressionBody(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstExpressionStatement : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ExpressionStatement;
        public CstExpressionStatement(string text) : base(text) { }
        // No children
    }
    ...
    /// <summary>
    /// Nodes = (TypeExpr+Identifier+Statement)
    /// </summary>
    ...
    /// Nodes = 
    /// </summary>
    public class CstForLoopInvariant : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ForLoopInvariant;
        public CstForLoopInvariant(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstForLoopVariant : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ForLoopVariant;
        public CstForLoopVariant(string text) : base(text) { }
        // No children
    }
    ...
    /// <summary>
    /// Nodes = (FunctionArgKeyword)*
    /// </summary>
    public class CstFunctionArg : CstNode
    {
    ...
    /// Nodes = 
    /// </summary>
    public class CstIndexer : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.Indexer;
        public CstIndexer(string text) : base(text) { }
        // No children
    }
    ...
    /// <summary>
    /// Nodes = ArrayInitializationValue
    /// </summary>
    public class CstInitializationValue : CstNode
    {
    ...
    /// Nodes = Identifier
    /// </summary>
    public class CstInitializerClause : CstNode
    {
    ...
    /// Nodes = CompoundStatement
    /// </summary>
    public class CstLambdaBody : CstNode
    {
    ...
    /// Nodes = 
    /// </summary>
    public class CstNameOf : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.NameOf;
        public CstNameOf(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstParenthesizedExpression : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ParenthesizedExpression;
        public CstParenthesizedExpression(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstReturnStatement : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ReturnStatement;
        public CstReturnStatement(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstStringInterpolationContent : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.StringInterpolationContent;
        public CstStringInterpolationContent(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstTernaryOperation : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.TernaryOperation;
        public CstTernaryOperation(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstThrowExpression : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.ThrowExpression;
        public CstThrowExpression(string text) : base(text) { }
        // No children
    }
    ...
    /// Nodes = 
    /// </summary>
    public class CstYieldReturn : CstNodeLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.YieldReturn;
        public CstYieldReturn(string text) : base(text) { }
        // No children
    }
