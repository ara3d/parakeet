...
namespace Parakeet.Cst.PlatoGrammarNameSpace
{
    ...
    {
        public static readonly PlatoGrammar Grammar = new PlatoGrammar();
        ...
        public CstNode InternalCreate(ParserTreeNode node)
        {
            switch (node.Type)
            {
                case "ArrayInitializationValue": return new CstArrayInitializationValue(node.Contents);
                ...
                case "ArraySizeSpecifier": return new CstArraySizeSpecifier(node.Contents);
                ...
                case "ExpressionBody": return new CstExpressionBody(node.Contents);
                case "ExpressionStatement": return new CstExpressionStatement(node.Contents);
                ...
                case "ForLoopInvariant": return new CstForLoopInvariant(node.Contents);
                case "ForLoopVariant": return new CstForLoopVariant(node.Contents);
                ...
                case "Indexer": return new CstIndexer(node.Contents);
                ...
                case "NameOf": return new CstNameOf(node.Contents);
                ...
                case "ParenthesizedExpression": return new CstParenthesizedExpression(node.Contents);
                ...
                case "ReturnStatement": return new CstReturnStatement(node.Contents);
                ...
                case "StringInterpolationContent": return new CstStringInterpolationContent(node.Contents);
                ...
                case "TernaryOperation": return new CstTernaryOperation(node.Contents);
                case "ThrowExpression": return new CstThrowExpression(node.Contents);
                ...
                case "YieldReturn": return new CstYieldReturn(node.Contents);
