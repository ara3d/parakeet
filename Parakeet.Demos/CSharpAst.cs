// DO NOT EDIT: Autogenerated file created on 2023-03-11 12:43:14 AM. 
using System;
using System.Linq;
...
namespace Parakeet.Demos.CSharp
{
    ...
    // Only Nodes: (HexLiteral|BinaryLiteral|FloatLiteral|IntegerLiteral|StringLiteral|CharLiteral|BooleanLiteral|NullLiteral)
    ...
    // Only Nodes: (MemberAccess|ConditionalMemberAccess|FunctionArgs|Indexer|TernaryOperation|BinaryOperation|IsOperation)
    ...
    // Original Rule: (!("=>")+BinaryOperator+_unknown_+Expression)
    ...
    // Original Rule: ("?"+WS+_unknown_+Expression+":"+WS+Expression)
    ...
    // Original Rule: ("throw"+!(IdentifierChar)+WS+_unknown_+Expression)
    // Only Nodes: Expression
    ...
    // Original Rule: (LambdaParameters+"=>"+WS+_unknown_+LambdaBody)
    ...
    // Original Rule: ("typeof"+!(IdentifierChar)+WS+_unknown_+"("+WS+TypeExpr+")"+WS)
    // Only Nodes: TypeExpr
    ...
    // Original Rule: ("nameof"+!(IdentifierChar)+WS+_unknown_+"("+WS+Expression+")"+WS)
    // Only Nodes: Expression
    ...
    // Original Rule: ("default"+!(IdentifierChar)+WS+_unknown_+(("("+WS+TypeExpr+")"+WS))?)
    // Only Nodes: (TypeExpr)?
    ...
    // Original Rule: ((Identifier+"="+WS+_unknown_+Expression)|Expression)
    ...
    // Original Rule: ("{"+WS+_unknown_+((InitializerClause+WS+((Comma+InitializerClause+WS))*))?+"}"+WS)
    ...
    // Original Rule: ("new"+!(IdentifierChar)+WS+_unknown_+TypeExpr+(FunctionArgs)?+(ArraySizeSpecifier)?+(Initializer)?)
    ...
    // Original Rule: ("is"+!(IdentifierChar)+WS+_unknown_+TypeExpr+(Identifier)?)
    // Only Nodes: (TypeExpr+(Identifier)?)
    ...
    // Original Rule: ("as"+!(IdentifierChar)+WS+_unknown_+TypeExpr+(Identifier)?)
    // Only Nodes: (TypeExpr+(Identifier)?)
    ...
    // Original Rule: (("{"+WS+_unknown_+Expression+"}"+WS)|StringLiteralChar)
    // Only Nodes: Expression
    ...
    // Original Rule: ("$"+_unknown_+"""+(StringInterpolationContent)*+""")
    ...
    // Only Nodes: (LambdaExpr|ParenthesizedExpression|ThrowExpression|Literal|TypeOf|NameOf|Default|NewOperation|StringInterpolation)
    ...
    // Original Rule: (Expression+_unknown_+EOS)
    // Only Nodes: Expression
    ...
    // Original Rule: ("else"+!(IdentifierChar)+WS+_unknown_+Statement)
    ...
    // Original Rule: ("if"+!(IdentifierChar)+WS+_unknown_+ParenthesizedExpression+Statement+(ElseClause)?)
    ...
    // Original Rule: ("while"+!(IdentifierChar)+WS+_unknown_+ParenthesizedExpression+Statement)
    ...
    // Original Rule: ("do"+!(IdentifierChar)+WS+_unknown_+Statement+"while"+!(IdentifierChar)+WS+ParenthesizedExpression+EOS)
    ...
    // Original Rule: ("return"+!(IdentifierChar)+WS+_unknown_+(Expression)?+EOS)
    // Only Nodes: (Expression)?
    ...
    // Original Rule: ("break"+!(IdentifierChar)+WS+_unknown_+EOS)
    // Only Nodes: 
    ...
    // Original Rule: ("yield"+!(IdentifierChar)+WS+_unknown_+(YieldReturn|YieldBreak))
    // Only Nodes: (YieldReturn)
    ...
    // Original Rule: ("continue"+!(IdentifierChar)+WS+_unknown_+EOS)
    // Only Nodes: 
    ...
    // Original Rule: ("{"+WS+_unknown_+(Statement)*+"}"+WS)
    // Only Nodes: (Statement)*
    ...
    // Original Rule: ("catch"+!(IdentifierChar)+WS+_unknown_+"("+WS+VarDecl+")"+WS+CompoundStatement)
    ...
    // Original Rule: ((("default"+!(IdentifierChar)+WS)|("case"+!(IdentifierChar)+WS+_unknown_+Expression))+Statement)
    ...
    // Original Rule: ("switch"+!(IdentifierChar)+WS+_unknown_+"{"+WS+_unknown_+(CaseClause)*+"}"+WS)
    ...
    // Original Rule: ("try"+!(IdentifierChar)+WS+_unknown_+CompoundStatement+(CatchClause)?+(FinallyClause)?)
    ...
    // Original Rule: ("foreach"+!(IdentifierChar)+WS+_unknown_+"("+WS+VarDecl+"in"+!(IdentifierChar)+WS+Expression+")"+WS+Statement)
    ...
    // Original Rule: ("for"+!(IdentifierChar)+WS+_unknown_+"("+WS+InitializationClause+EOS+InvariantClause+EOS+VariantClause+")"+WS+Statement)
    ...
    // Original Rule: (("="+WS+_unknown_+Expression))?
    // Only Nodes: (Expression)?
    ...
    // Only Nodes: (CompoundStatement|IfStatement|WhileStatement|DoWhileStatement|ReturnStatement|BreakStatement|ContinueStatement|ForStatement|ForEachStatement|VarDeclStatement|TryStatement)
    ...
    // Original Rule: ("using"+!(IdentifierChar)+WS+_unknown_+Static+QualifiedIdentifier+EOS)
    ...
    // Only Nodes: (AttributeList+((Modifier))*)
    ...
    // Original Rule: (Kind+_unknown_+Identifier+TypeParameterList+BaseClassList+ConstraintList+"{"+WS+_unknown_+(MemberDeclaration)*+"}"+WS)
    ...
    // Original Rule: ("=>"+WS+_unknown_+((Expression+EOS)|CompoundStatement))
    // Only Nodes: (Expression)
    ...
    // Original Rule: ("base"+!(IdentifierChar)+WS+_unknown_+ParenthesizedExpression)
    ...
    // Original Rule: ("this"+!(IdentifierChar)+WS+_unknown_+ParenthesizedExpression)
    // Only Nodes: ParenthesizedExpression
    ...
    // Original Rule: (Identifier+FunctionParameterList+_unknown_+BaseOrThisCall+FunctionBody)
    ...
    // Original Rule: (TypeExpr+Identifier+FunctionParameterList+_unknown_+FunctionBody)
    ...
    // Original Rule: ("get"+!(IdentifierChar)+WS+_unknown_+FunctionBody)
    ...
    // Original Rule: ("set"+!(IdentifierChar)+WS+_unknown_+FunctionBody)
    // Only Nodes: FunctionBody
    ...
    // Original Rule: ("init"+!(IdentifierChar)+WS+_unknown_+FunctionBody)
    // Only Nodes: FunctionBody
    ...
    // Original Rule: (ExpressionBody|("{"+WS+_unknown_+PropertyClauses+"}"+WS))
    // Only Nodes: (ExpressionBody)
    ...
    // Original Rule: (TypeExpr+"this"+!(IdentifierChar)+WS+_unknown_+"["+WS+FunctionParameter+"]"+WS+PropertyBody)
    ...
    // Original Rule: (TypeExpr+"operator"+!(IdentifierChar)+WS+_unknown_+OverloadableOperator+FunctionParameterList+FunctionBody)
    ...
    // Only Nodes: (DeclarationPreamble+(ConstructorDeclaration|MethodDeclaration|IndexerDeclaration|PropertyDeclaration|FieldDeclaration|OperatorDeclaration|ConverterDeclaration))
    ...
    // Original Rule: ("namespace"+!(IdentifierChar)+WS+QualifiedIdentifier+"{"+WS+_unknown_+(TopDeclaration)*+"}"+WS)
    ...
    // Only Nodes: (NamespaceDeclaration)
    ...
    // Original Rule: (Separator|CppStyleComment|Spaces|([!%^&|*?+-=/><:@#~$]+([!%^&|*?+-=/><:@#~$])*)|Identifier|Literal)
    // Only Nodes: (Separator|Identifier)
    ...
    // Original Rule: ((!([[]{}()])+(Token|Separator))+((!([[]{}()])+(Token|Separator)))*)
    // Only Nodes: ((Token)+((Token))*)
    ...
    // Only Nodes: (BracketedStructure|ParenthesizedStructure)
