// DO NOT EDIT: Autogenerated file created on 2023-03-12 8:02:51 PM. 
using System;
using System.Linq;
...
namespace Parakeet.Demos.CSharp
{
    ...
    // Original Rule: (Digits+!([\x2EfFdDmM])+(IntegerSuffix)?)
    // Only Nodes: 
    ...
    // Original Rule: (_UNKNOWN_+(StringLiteralChar)*+_UNKNOWN_)
    // Only Nodes: 
    ...
    // Original Rule: (_UNKNOWN_+CharLiteralChar+_UNKNOWN_)
    // Only Nodes: 
    ...
    // Original Rule: ((">>>="+WS)|(">>>"+WS)|(">>="+WS)|("<<="+WS)|("\x26\x26="+WS)|("||="+WS)|(">>"+WS)|("<<"+WS)|("\x26\x26"+WS)|("||"+WS)|("+="+WS)|("\x2D="+WS)|("\x2A="+WS)|("\x2F="+WS)|("\x25="+WS)|("\x26="+WS)|("|="+WS)|("^="+WS)|("<="+WS)|(">="+WS)|("=="+WS)|("\x21="+WS)|("\x3F\x3F"+WS)|("\x3F="+WS)|("+"+WS)|("\x2D"+WS)|("\x2A"+WS)|("\x2F"+WS)|("\x25"+WS)|("\x26"+WS)|("|"+WS)|("^"+WS)|("="+WS)|("<"+WS)|(">"+WS))
    // Only Nodes: 
    ...
    // Original Rule: (("++"+WS)|("\x2D\x2D"+WS)|("\x21"+WS)|("\x2D"+WS)|("+"+WS)|("~"+WS))
    // Only Nodes: 
    ...
    // Original Rule: ("\x5B"+WS+Expression+"\x5D"+WS)
    // Only Nodes: (Expression)
    public class Indexer : AstSequence
    {
    ...
    // Original Rule: ((">>>"+WS)|("++"+WS)|("\x2D\x2D"+WS)|("<<"+WS)|(">>"+WS)|("=="+WS)|("\x21="+WS)|("<="+WS)|(">="+WS)|("+"+WS)|("\x2D"+WS)|("\x21"+WS)|("~"+WS)|("\x2A"+WS)|("\x2F"+WS)|("\x25"+WS)|("\x26"+WS)|("|"+WS)|("^"+WS)|("<"+WS)|(">"+WS))
    // Only Nodes: 
    ...
    // Original Rule: (("++"+WS)|("\x2D\x2D"+WS)|("\x21"+WS)|("\x3F"+WS)|MemberAccess|ConditionalMemberAccess|FunctionArgs|Indexer|TernaryOperation|BinaryOperation|IsOperation|AsOperation)
    ...
    // Original Rule: ("\x3F"+WS+_RECOVER_+Expression+"\x3A"+WS+Expression)
    ...
    // Original Rule: ("\x28"+WS+((Expression+WS+((Comma+Expression+WS))*))?+"\x29"+WS)
    // Only Nodes: (((Expression+((Expression))*))?)
    public class ParenthesizedExpression : AstSequence
    {
        ...
        public AstOptional<AstNode> SequenceRule => Children[0] as AstOptional<AstNode>;
    }

    // Original Rule: ("throw"+!(IdentifierChar)+WS+_RECOVER_+Expression)
    // Only Nodes: (Expression)
    public class ThrowExpression : AstSequence
    {
    ...
    public class LambdaParameter : AstChoice
    {
        ...
        public AstSequence SequenceRule => Children[0] as AstSequence;
        public Identifier Identifier => Children[0] as Identifier;
    }

    // Original Rule: (LambdaParameter|("\x28"+WS+((LambdaParameter+WS+((Comma+LambdaParameter+WS))*))?+"\x29"+WS))
    ...
    // Original Rule: (LambdaParameters+"=>"+WS+_RECOVER_+LambdaBody)
    ...
    // Original Rule: ("\x2E"+WS+Identifier)
    // Only Nodes: (Identifier)
    public class MemberAccess : AstSequence
    {
    ...
    // Original Rule: ("\x3F\x2E"+WS+Identifier)
    // Only Nodes: (Identifier)
    public class ConditionalMemberAccess : AstSequence
    {
    ...
    // Original Rule: ("typeof"+!(IdentifierChar)+WS+_RECOVER_+"\x28"+WS+TypeExpr+"\x29"+WS)
    // Only Nodes: (TypeExpr)
    public class TypeOf : AstSequence
    {
    ...
    // Original Rule: ("nameof"+!(IdentifierChar)+WS+_RECOVER_+"\x28"+WS+Expression+"\x29"+WS)
    // Only Nodes: (Expression)
    public class NameOf : AstSequence
    {
    ...
    // Original Rule: ("default"+!(IdentifierChar)+WS+_RECOVER_+(("\x28"+WS+TypeExpr+"\x29"+WS))?)
    // Only Nodes: (((TypeExpr))?)
    public class Default : AstSequence
    {
    ...
    // Original Rule: ((Identifier+"="+WS+_RECOVER_+Expression)|Expression)
    ...
    // Original Rule: ("\x7B"+WS+_RECOVER_+((InitializerClause+WS+((Comma+InitializerClause+WS))*))?+"\x7D"+WS)
    // Only Nodes: (((InitializerClause+((InitializerClause))*))?)
    public class Initializer : AstSequence
    {
    ...
    // Original Rule: ("\x5B"+WS+Expression+"\x5D"+WS)
    // Only Nodes: (Expression)
    public class ArraySizeSpecifier : AstSequence
    {
    ...
    // Original Rule: ("new"+!(IdentifierChar)+WS+_RECOVER_+TypeExpr+(FunctionArgs)?+(ArraySizeSpecifier)?+(Initializer)?)
    ...
    // Original Rule: ("is"+!(IdentifierChar)+WS+_RECOVER_+TypeExpr+(Identifier)?)
    ...
    // Original Rule: ("as"+!(IdentifierChar)+WS+_RECOVER_+TypeExpr+(Identifier)?)
    // Only Nodes: (TypeExpr+(Identifier)?)
    ...
    // Original Rule: (("\x7B"+WS+_RECOVER_+Expression+"\x7D"+WS)|StringLiteralChar)
    // Only Nodes: ((Expression))
    public class StringInterpolationContent : AstChoice
    {
    ...
    public class StringInterpolation : AstSequence
    {
        ...
        public AstZeroOrMore<StringInterpolationContent> ZeroOrMoreRuleStringInterpolationContent => Children[0] as AstZeroOrMore<StringInterpolationContent>;
    }
    ...
    public class FunctionArg : AstSequence
    {
        ...
        public AstZeroOrMore<FunctionArgKeyword> ZeroOrMoreRuleFunctionArgKeyword => Children[0] as AstZeroOrMore<FunctionArgKeyword>;
        public Expression Expression => Children[1] as Expression;
    }

    // Original Rule: ("\x28"+WS+((FunctionArg+WS+((Comma+FunctionArg+WS))*))?+"\x29"+WS)
    // Only Nodes: (((FunctionArg+((FunctionArg))*))?)
    public class FunctionArgs : AstSequence
    {
    ...
    public class Expression : AstSequence
    {
        ...
        public AstZeroOrMore<UnaryOperator> ZeroOrMoreRuleUnaryOperator => Children[0] as AstZeroOrMore<UnaryOperator>;
        public LeafExpression LeafExpression => Children[1] as LeafExpression;
        public AstZeroOrMore<PostfixOperator> ZeroOrMoreRulePostfixOperator => Children[2] as AstZeroOrMore<PostfixOperator>;
    }

    // Original Rule: (Expression+_RECOVER_+EOS)
    // Only Nodes: (Expression)
    public class ExpressionStatement : AstSequence
    {
    ...
    // Original Rule: ("else"+!(IdentifierChar)+WS+_RECOVER_+Statement)
    // Only Nodes: (Statement)
    public class ElseClause : AstSequence
    {
    ...
    // Original Rule: ("if"+!(IdentifierChar)+WS+_RECOVER_+ParenthesizedExpression+Statement+(ElseClause)?)
    ...
    // Original Rule: ("while"+!(IdentifierChar)+WS+_RECOVER_+ParenthesizedExpression+Statement)
    ...
    // Original Rule: ("do"+!(IdentifierChar)+WS+_RECOVER_+Statement+"while"+!(IdentifierChar)+WS+ParenthesizedExpression+EOS)
    ...
    // Original Rule: ("return"+!(IdentifierChar)+WS+_RECOVER_+(Expression)?+EOS)
    // Only Nodes: ((Expression)?)
    public class ReturnStatement : AstSequence
    {
    ...
    // Original Rule: ("yield"+!(IdentifierChar)+WS+_RECOVER_+(YieldReturn|YieldBreak))
    // Only Nodes: ((YieldReturn|YieldBreak))
    public class YieldStatement : AstSequence
    {
        ...
        public AstChoice ChoiceRule => Children[0] as AstChoice;
    }

    // Original Rule: ("return"+!(IdentifierChar)+WS+_RECOVER_+Expression+EOS)
    // Only Nodes: (Expression)
    public class YieldReturn : AstSequence
    {
    ...
    // Original Rule: ("\x7B"+WS+_RECOVER_+(Statement)*+"\x7D"+WS)
    // Only Nodes: ((Statement)*)
    public class CompoundStatement : AstSequence
    {
        ...
        public AstZeroOrMore<Statement> ZeroOrMoreRuleStatement => Children[0] as AstZeroOrMore<Statement>;
    }

    // Original Rule: ("catch"+!(IdentifierChar)+WS+_RECOVER_+"\x28"+WS+VarDecl+"\x29"+WS+CompoundStatement)
    ...
    public class FinallyClause : AstSequence
    {
    ...
    // Original Rule: ((("default"+!(IdentifierChar)+WS)|("case"+!(IdentifierChar)+WS+_RECOVER_+Expression))+Statement)
    ...
    // Original Rule: ("switch"+!(IdentifierChar)+WS+_RECOVER_+"\x7B"+WS+_RECOVER_+(CaseClause)*+"\x7D"+WS)
    // Only Nodes: ((CaseClause)*)
    public class SwitchStatement : AstSequence
    {
        ...
        public AstZeroOrMore<CaseClause> ZeroOrMoreRuleCaseClause => Children[0] as AstZeroOrMore<CaseClause>;
    }

    // Original Rule: ("try"+!(IdentifierChar)+WS+_RECOVER_+CompoundStatement+(CatchClause)?+(FinallyClause)?)
    ...
    // Original Rule: ("foreach"+!(IdentifierChar)+WS+_RECOVER_+"\x28"+WS+VarDecl+"in"+!(IdentifierChar)+WS+Expression+"\x29"+WS+Statement)
    ...
    // Original Rule: ("for"+!(IdentifierChar)+WS+_RECOVER_+"\x28"+WS+InitializationClause+EOS+InvariantClause+EOS+VariantClause+"\x29"+WS+Statement)
    ...
    // Original Rule: (("="+WS+_RECOVER_+Expression))?
    // Only Nodes: ((Expression))?
    ...
    // Original Rule: (EOS|CompoundStatement|IfStatement|WhileStatement|DoWhileStatement|ReturnStatement|BreakStatement|ContinueStatement|ForStatement|ForEachStatement|VarDeclStatement|TryStatement|ExpressionStatement)
    ...
    // Original Rule: ((Identifier+WS+(("\x2E"+WS+Identifier+WS))*))?
    ...
    // Original Rule: ("using"+!(IdentifierChar)+WS+_RECOVER_+Static+QualifiedIdentifier+EOS)
    ...
    // Original Rule: ("\x5B"+WS+((Identifier+(FunctionArgs)?+WS+((Comma+Identifier+(FunctionArgs)?+WS))*))?+"\x5D"+WS)
    // Only Nodes: (((Identifier+(FunctionArgs)?+((Identifier+(FunctionArgs)?))*))?)
    public class Attribute : AstSequence
    {
    ...
    public class AttributeList : AstNode
    {
        ...
        public AstZeroOrMore<Attribute> ZeroOrMoreRuleAttribute => Children[0] as AstZeroOrMore<Attribute>;
    }
    ...
    public class DeclarationPreamble : AstSequence
    {
        ...
        public AstZeroOrMore<AstNode> ZeroOrMoreRuleChoiceRule => Children[1] as AstZeroOrMore<AstNode>;
    }
    ...
    // Original Rule: (("\x3A"+WS+((TypeExpr+WS+((Comma+TypeExpr+WS))*))?))?
    ...
    // Only Nodes: (TypeExpr)
    public class Constraint : AstChoice
    {
    ...
    // Original Rule: ("where"+!(IdentifierChar)+WS+Identifier+"\x3A"+WS+TypeExpr)
    ...
    public class ConstraintList : AstNode
    {
        ...
        public AstZeroOrMore<ConstraintClause> ZeroOrMoreRuleConstraintClause => Children[0] as AstZeroOrMore<ConstraintClause>;
    }
    ...
    // Original Rule: (Kind+_RECOVER_+Identifier+TypeParameterList+BaseClassList+ConstraintList+"\x7B"+WS+_RECOVER_+(MemberDeclaration)*+"\x7D"+WS)
    ...
    public class TypeDeclaration : AstSequence
    {
        ...
        public AstZeroOrMore<MemberDeclaration> ZeroOrMoreRuleMemberDeclaration => Children[5] as AstZeroOrMore<MemberDeclaration>;
    }
    ...
    // Original Rule: ("\x28"+WS+((FunctionParameter+WS+((Comma+FunctionParameter+WS))*))?+"\x29"+WS)
    // Only Nodes: (((FunctionParameter+((FunctionParameter))*))?)
    public class FunctionParameterList : AstSequence
    {
    ...
    // Original Rule: ("=>"+WS+_RECOVER_+((Expression+EOS)|CompoundStatement))
    // Only Nodes: (((Expression)|CompoundStatement))
    public class ExpressionBody : AstSequence
    {
    ...
    // Original Rule: (ExpressionBody|CompoundStatement|EOS)
    ...
    // Original Rule: ("base"+!(IdentifierChar)+WS+_RECOVER_+ParenthesizedExpression)
    // Only Nodes: (ParenthesizedExpression)
    public class BaseCall : AstSequence
    {
    ...
    // Original Rule: ("this"+!(IdentifierChar)+WS+_RECOVER_+ParenthesizedExpression)
    // Only Nodes: (ParenthesizedExpression)
    public class ThisCall : AstSequence
    {
    ...
    // Original Rule: (("\x3A"+WS+(BaseCall|ThisCall)))?
    ...
    // Original Rule: (TypeExpr+Identifier+(Initialization)?+EOS)
    ...
    // Original Rule: ("get"+!(IdentifierChar)+WS+_RECOVER_+FunctionBody)
    // Only Nodes: (FunctionBody)
    public class Getter : AstSequence
    {
    ...
    // Original Rule: ("set"+!(IdentifierChar)+WS+_RECOVER_+FunctionBody)
    // Only Nodes: (FunctionBody)
    public class Setter : AstSequence
    {
    ...
    // Original Rule: ("init"+!(IdentifierChar)+WS+_RECOVER_+FunctionBody)
    // Only Nodes: (FunctionBody)
    public class Initter : AstSequence
    {
    ...
    public class PropertyClauses : AstNode
    {
        ...
        public AstZeroOrMore<AstNode> ZeroOrMoreRuleChoiceRule => Children[0] as AstZeroOrMore<AstNode>;
    }

    // Original Rule: (ExpressionBody|("\x7B"+WS+_RECOVER_+PropertyClauses+"\x7D"+WS))
    ...
    // Original Rule: (TypeExpr+"this"+!(IdentifierChar)+WS+_RECOVER_+"\x5B"+WS+FunctionParameter+"\x5D"+WS+PropertyBody)
    ...
    // Original Rule: (TypeExpr+"operator"+!(IdentifierChar)+WS+_RECOVER_+OverloadableOperator+FunctionParameterList+FunctionBody)
    ...
    public class MemberDeclaration : AstSequence
    {
        ...
        public DeclarationPreamble DeclarationPreamble => Children[0] as DeclarationPreamble;
        public AstChoice ChoiceRule => Children[1] as AstChoice;
    }

    // Original Rule: ("namespace"+!(IdentifierChar)+WS+QualifiedIdentifier+"\x7B"+WS+_RECOVER_+(TopDeclaration)*+"\x7D"+WS)
    ...
    public class NamespaceDeclaration : AstSequence
    {
        ...
        public AstZeroOrMore<TopDeclaration> ZeroOrMoreRuleTopDeclaration => Children[1] as AstZeroOrMore<TopDeclaration>;
    }

    // Original Rule: ("namespace"+!(IdentifierChar)+WS+QualifiedIdentifier+EOS)
    // Only Nodes: (QualifiedIdentifier)
    public class FileScopedNamespace : AstSequence
    {
    ...
    public class File : AstSequence
    {
        ...
        public AstZeroOrMore<UsingDirective> ZeroOrMoreRuleUsingDirective => Children[0] as AstZeroOrMore<UsingDirective>;
        public AstOptional<FileScopedNamespace> FileScopedNamespace => Children[1] as AstOptional<FileScopedNamespace>;
        public AstZeroOrMore<TopDeclaration> ZeroOrMoreRuleTopDeclaration => Children[2] as AstZeroOrMore<TopDeclaration>;
    }

    // Original Rule: ("\x5B"+WS+(Comma)*+"\x5D"+WS)
    // Only Nodes: 
    ...
    public class ArrayRankSpecifiers : AstNode
    {
        ...
        public AstZeroOrMore<ArrayRankSpecifier> ZeroOrMoreRuleArrayRankSpecifier => Children[0] as AstZeroOrMore<ArrayRankSpecifier>;
    }

    // Original Rule: ("<"+WS+((TypeExpr+WS+((Comma+TypeExpr+WS))*))?+">"+WS)
    // Only Nodes: (((TypeExpr+((TypeExpr))*))?)
    public class TypeArgList : AstSequence
    {
    ...
    // Original Rule: (Separator|CppStyleComment|Spaces|([\x21\x25^\x26|\x2A\x3F+\x2D=\x2F><\x3A\x40\x23~$]+([\x21\x25^\x26|\x2A\x3F+\x2D=\x2F><\x3A\x40\x23~$])*)|Identifier|Literal)
    ...
    public class TokenGroup : AstSequence
    {
        ...
        public AstSequence SequenceRule => Children[0] as AstSequence;
        public AstZeroOrMore<AstNode> ZeroOrMoreRuleSequenceRule => Children[1] as AstZeroOrMore<AstNode>;
    }
    ...
    // Only Nodes: ((Element)*)
    public class BracedStructure : AstSequence
    {
        ...
        public AstZeroOrMore<Element> ZeroOrMoreRuleElement => Children[0] as AstZeroOrMore<Element>;
    }

    // Original Rule: ("\x5B"+(Element)*+"\x5D")
    // Only Nodes: ((Element)*)
    public class BracketedStructure : AstSequence
    {
    ...
    // Only Nodes: ((Element)*)
    public class ParenthesizedStructure : AstSequence
    {
