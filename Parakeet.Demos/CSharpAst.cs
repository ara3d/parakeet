// DO NOT EDIT: Autogenerated file created on 2023-03-11 12:05:27 AM. 
using System;
using System.Linq;
...
namespace Parakeet.Demos.CSharp
{
    ...
    // Original Rule: ("["+WS+_unknown_+Expression+"]"+WS)
    ...
    // Original Rule: ("["+WS+_unknown_+((Identifier+(FunctionArgs)?+WS+((Comma+Identifier+(FunctionArgs)?+WS))*))?+"]"+WS)
    ...
    // Original Rule: (TypeExpr+"this"+!(IdentifierChar)+WS+_unknown_+"["+WS+_unknown_+FunctionParameter+"]"+WS+PropertyBody)
    ...
    // Only Nodes: ((DeclarationPreamble+ConstructorDeclaration)|MethodDeclaration|FieldDeclaration|OperatorDeclaration|ConverterDeclaration|TypeDeclaration|IndexerDeclaration)
    ...
    // Original Rule: ("["+WS+_unknown_+(Comma)*+"]"+WS)
    // Only Nodes: 
