// DO NOT EDIT: Autogenerated file created on 2023-03-12 12:48:47 PM. 
using System;
using System.Linq;

namespace Parakeet.Demos.CSharp
{
    // Original Rule: ([0..9]+([0..9])*+(("\x2E"+([0..9])*))?+(([eE]+([+\x2D])?+[0..9]+([0..9])*))?+([fFdDmM])?)
    // Only Nodes: 
    ...
    // Original Rule: (("0x"|"0X")+([0..9]|[a..f]|[A..F])+(([0..9]|[a..f]|[A..F]))*+(("ul"|"UL"|"lu"|"lU"|"Lu"|"LU"|"u"|"U"|"l"|"L"))?)
    // Only Nodes: 
    ...
    // Original Rule: ("0b"|("0B"+[0..1]+([0..1])*+(("ul"|"UL"|"lu"|"lU"|"Lu"|"LU"|"u"|"U"|"l"|"L"))?))
    // Only Nodes: 
    ...
    // Original Rule: ([0..9]+([0..9])*+!([\x2EfFdDmM])+(("ul"|"UL"|"lu"|"lU"|"Lu"|"LU"|"u"|"U"|"l"|"L"))?)
    // Only Nodes: 
    ...
    // Original Rule: ([\x22]+((([\x5C]+_ANY_)|(!([\x22])+_ANY_)))*+[\x22])
    // Only Nodes: 
    ...
    // Original Rule: ([\x27]+(([\x5C]+_ANY_)|(!([\x27])+_ANY_))+[\x27])
    // Only Nodes: 
    ...
    // Original Rule: (("true"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("false"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: ("null"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: 
    ...
    // Original Rule: ("value"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: 
    ...
    // Original Rule: ((">>>="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|(">>>"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|(">>="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("<<="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x26\x26="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("||="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|(">>"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("<<"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x26\x26"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("||"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("+="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2D="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2A="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2F="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x25="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x26="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("|="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("^="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("<="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|(">="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("=="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x21="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x3F\x3F"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x3F="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("+"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2A"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2F"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x25"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x26"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("|"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("^"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("<"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|(">"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: (("++"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2D\x2D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x21"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("+"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("~"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: ("\x5B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Expression+"\x5D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: (("++"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x2D\x2D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x21"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("\x3F"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|MemberAccess|ConditionalMemberAccess|FunctionArgs|Indexer|TernaryOperation|BinaryOperation|IsOperation|AsOperation)
    ...
    // Original Rule: (([\x5F]|[a..z]|[A..Z])+(([\x5F]|[a..z]|[A..Z]|[0..9]))*)
    // Only Nodes: 
    ...
    // Original Rule: (!("=>")+BinaryOperator+_RECOVER_+Expression)
    ...
    // Original Rule: ("\x3F"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression+"\x3A"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Expression)
    ...
    // Original Rule: ("\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((Expression+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Expression+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: (Expression)*
    ...
    // Original Rule: ("throw"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression)
    // Only Nodes: Expression
    ...
    public class LambdaParameter : AstChoice
    {
    ...
    // Original Rule: (LambdaParameter|("\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((LambdaParameter+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+LambdaParameter+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: (LambdaParameter|(LambdaParameter)*)
    public class LambdaParameters : AstChoice
    {
        ...
        public LambdaParameter LambdaParameter => Children[0] as LambdaParameter;
    ...
    // Original Rule: (LambdaParameters+"=>"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+LambdaBody)
    ...
    // Original Rule: ("\x2E"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Identifier)
    ...
    // Original Rule: ("\x3F\x2E"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Identifier)
    // Only Nodes: Identifier
    ...
    // Original Rule: ("typeof"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+TypeExpr+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: TypeExpr
    ...
    // Original Rule: ("nameof"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Expression+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: Expression
    ...
    // Original Rule: ("default"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(("\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+TypeExpr+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))?)
    // Only Nodes: (TypeExpr)?
    ...
    // Original Rule: ((Identifier+"="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression)|Expression)
    // Only Nodes: ((Identifier+Expression)|Expression)
    public class InitializerClause : AstChoice
    {
    ...
    // Original Rule: ("\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+((InitializerClause+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+InitializerClause+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: ("new"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+TypeExpr+(FunctionArgs)?+(ArraySizeSpecifier)?+(Initializer)?)
    ...
    // Original Rule: ("is"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+TypeExpr+(Identifier)?)
    ...
    // Original Rule: ("as"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+TypeExpr+(Identifier)?)
    // Only Nodes: (TypeExpr+(Identifier)?)
    ...
    // Original Rule: (("\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|([\x5C]+_ANY_)|(!([\x22])+_ANY_))
    // Only Nodes: Expression
    ...
    // Original Rule: ("$"+_RECOVER_+"\x22"+(StringInterpolationContent)*+"\x22")
    ...
    // Original Rule: (("params"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("ref"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("out"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("in"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: ("\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((FunctionArg+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+FunctionArg+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: (Expression+_RECOVER_+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: Expression
    ...
    // Original Rule: ("else"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Statement)
    ...
    // Original Rule: ("if"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+ParenthesizedExpression+Statement+(ElseClause)?)
    ...
    // Original Rule: ("while"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+ParenthesizedExpression+Statement)
    ...
    // Original Rule: ("do"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Statement+"while"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+ParenthesizedExpression+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: ("return"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(Expression)?+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: (Expression)?
    ...
    // Original Rule: ("break"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: 
    ...
    // Original Rule: ("yield"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(YieldReturn|YieldBreak))
    // Only Nodes: (YieldReturn|YieldBreak)
    public class YieldStatement : AstChoice
    {
        ...
        public YieldReturn YieldReturn => Children[0] as YieldReturn;
        public YieldBreak YieldBreak => Children[0] as YieldBreak;
    }

    // Original Rule: ("return"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: Expression
    public class YieldReturn : AstNode
    {
        public YieldReturn(params AstNode[] children) : base(children) { }
        public override AstNode Transform(Func<AstNode, AstNode> f) => new YieldReturn(Children.Select(f).ToArray());
        public Expression Expression => Children[0] as Expression;
    }

    // Original Rule: ("break"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: 
    public class YieldBreak : AstNode
    {
        public YieldBreak(params AstNode[] children) : base(children) { }
        public override AstNode Transform(Func<AstNode, AstNode> f) => new YieldBreak(Children.Select(f).ToArray());
        // No children
    }

    // Original Rule: ("continue"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: 
    ...
    // Original Rule: ("\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(Statement)*+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: (Statement)*
    ...
    // Original Rule: ("catch"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+VarDecl+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+CompoundStatement)
    ...
    // Original Rule: ("finally"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+CompoundStatement)
    ...
    // Original Rule: ((("default"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("case"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression))+Statement)
    ...
    // Original Rule: ("switch"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(CaseClause)*+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: ("try"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+CompoundStatement+(CatchClause)?+(FinallyClause)?)
    ...
    // Original Rule: ("foreach"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+VarDecl+"in"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Expression+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Statement)
    ...
    // Original Rule: ("for"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+InitializationClause+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+InvariantClause+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+VariantClause+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Statement)
    ...
    // Original Rule: (("="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Expression))?
    // Only Nodes: (Expression)?
    ...
    // Original Rule: (VarDecl+Initialization+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    // Only Nodes: (VarDecl+Initialization)
    ...
    // Original Rule: (("\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|CompoundStatement|IfStatement|WhileStatement|DoWhileStatement|ReturnStatement|BreakStatement|ContinueStatement|ForStatement|ForEachStatement|VarDeclStatement|TryStatement|ExpressionStatement)
    // Only Nodes: (CompoundStatement|IfStatement|WhileStatement|DoWhileStatement|ReturnStatement|BreakStatement|ContinueStatement|ForStatement|ForEachStatement|VarDeclStatement|TryStatement|ExpressionStatement)
    ...
    // Original Rule: ((Identifier+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2E"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Identifier+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?
    // Only Nodes: (Identifier)*
    ...
    // Original Rule: (("static"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))?
    // Only Nodes: 
    ...
    // Original Rule: ("using"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+Static+QualifiedIdentifier+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: (("readonly"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("abstract"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("partial"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("virtual"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("static"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("sealed"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("const"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("ref"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: (("protected"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("internal"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("private"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("public"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: ("\x5B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((Identifier+(FunctionArgs)?+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Identifier+(FunctionArgs)?+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+"\x5D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: ((("out"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("in"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)))?
    // Only Nodes: 
    ...
    // Original Rule: (("<"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((TypeParameter+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+TypeParameter+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+">"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))?
    ...
    // Original Rule: (("\x3A"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((TypeExpr+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+TypeExpr+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?))?
    // Only Nodes: (TypeExpr)*
    ...
    // Original Rule: (("class"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("struct"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|TypeExpr)
    // Only Nodes: TypeExpr
    ...
    // Original Rule: ("where"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Identifier+"\x3A"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+TypeExpr)
    ...
    // Original Rule: (("interface"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("struct"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("class"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("enum"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: (Kind+_RECOVER_+Identifier+TypeParameterList+BaseClassList+ConstraintList+"\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(MemberDeclaration)*+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: (("="+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+Expression))?
    // Only Nodes: (Expression)?
    ...
    // Original Rule: ("\x28"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+((FunctionParameter+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(("\x2C"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+FunctionParameter+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))*))?+"\x29"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    public class ExpressionBody : AstChoice
    {
    ...
    // Original Rule: (ExpressionBody|CompoundStatement|("\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    ...
    // Original Rule: ("base"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+ParenthesizedExpression)
    ...
    // Original Rule: ("this"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+ParenthesizedExpression)
    // Only Nodes: ParenthesizedExpression
    ...
    // Original Rule: (("\x3A"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+(BaseCall|ThisCall)))?
    ...
    // Original Rule: (Identifier+FunctionParameterList+_RECOVER_+BaseOrThisCall+FunctionBody)
    ...
    // Original Rule: (TypeExpr+Identifier+FunctionParameterList+_RECOVER_+FunctionBody)
    ...
    // Original Rule: (TypeExpr+Identifier+(Initialization)?+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    public class FieldDeclaration : AstSequence
    {
        ...
        public TypeExpr TypeExpr => Children[0] as TypeExpr;
        public Identifier Identifier => Children[1] as Identifier;
        public AstOptional<Initialization> Initialization => Children[2] as AstOptional<Initialization>;
    }

    // Original Rule: ("get"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+FunctionBody)
    ...
    // Original Rule: ("set"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+FunctionBody)
    // Only Nodes: FunctionBody
    ...
    // Original Rule: ("init"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+FunctionBody)
    // Only Nodes: FunctionBody
    ...
    // Original Rule: (ExpressionBody|("\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+PropertyClauses+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    ...
    // Original Rule: (TypeExpr+"this"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+"\x5B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+FunctionParameter+"\x5D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+PropertyBody)
    ...
    // Original Rule: (TypeExpr+"operator"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+OverloadableOperator+FunctionParameterList+FunctionBody)
    ...
    // Original Rule: (("implicit"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("explicit"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: (TypeExpr+ImplicitOrExplicit+"operator"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+TypeExpr+FunctionBody)
    ...
    // Original Rule: (DeclarationPreamble+(ConstructorDeclaration|MethodDeclaration|IndexerDeclaration|PropertyDeclaration|FieldDeclaration|OperatorDeclaration|ConverterDeclaration|TypeDeclaration))
    ...
    public class MemberDeclaration : AstSequence
    {
        ...
        public DeclarationPreamble DeclarationPreamble => Children[0] as DeclarationPreamble;
        public AstChoice Choice => Children[1] as AstChoice;
    }

    // Original Rule: ("namespace"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+QualifiedIdentifier+"\x7B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+_RECOVER_+(TopDeclaration)*+"\x7D"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: ("namespace"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*+QualifiedIdentifier+"\x3B"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)
    ...
    // Original Rule: (("\x3F"+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))?
    // Only Nodes: 
    ...
    // Original Rule: ([\x3B\x2C\x2E]|TypeKeyword|StatementKeyword)
    ...
    // Original Rule: (("continue"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("foreach"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("finally"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("default"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("return"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("switch"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("break"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("throw"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("catch"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("using"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("case"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("for"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("try"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("if"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*)|("do"+!(([\x5F]|[a..z]|[A..Z]|[0..9]))+((([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")))*))
    // Only Nodes: 
    ...
    // Original Rule: (Separator|("\x2F\x2F"+((!(("\x0D\x0A"|"\x0A"))+_ANY_))*+(("\x0D\x0A"|"\x0A"))?)|("\x2F\x2A"+((!("\x2A\x2F")+_ANY_))*+"\x2A\x2F")|([\x20\x09\x0A\x0D\x00\x0B\x0C]+([\x20\x09\x0A\x0D\x00\x0B\x0C])*)|([\x21\x25^\x26|\x2A\x3F+\x2D=\x2F><\x3A\x40\x23~$]+([\x21\x25^\x26|\x2A\x3F+\x2D=\x2F><\x3A\x40\x23~$])*)|Identifier|Literal)
    ...
    public class Token : AstChoice
    {
        ...
        public Separator Separator => Children[0] as Separator;
        public Identifier Identifier => Children[0] as Identifier;
        public Literal Literal => Children[0] as Literal;
    }

    // Original Rule: (!([\x5B\x5D\x7B\x7D\x28\x29])+(Token|Separator)+((!([\x5B\x5D\x7B\x7D\x28\x29])+(Token|Separator)))*)
    ...
    public class TokenGroup : AstSequence
    {
        ...
        public AstChoice Choice => Children[0] as AstChoice;
        public AstZeroOrMore<AstNode> ZeroOrMoreChoice => Children[1] as AstZeroOrMore<AstNode>;
    }
    ...
    public static class AstNodeFactory
    {
        public static AstNode Create(ParseTree node)
        {
            switch (node.Type)
            {
                ...
                case "FileScopedNamespace": return new FileScopedNamespace(node.Children.Select(Create).ToArray());
                case "TopDeclaration": return new TopDeclaration(node.Children.Select(Create).ToArray());
