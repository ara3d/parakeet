// DO NOT EDIT: Autogenerated file created on 2023-03-10 10:51:00 AM. 
using System;
using System.Linq;
...
namespace Parakeet.Demos.CSharp
{
    ...
    // Original Rule: ("["+WS+OnError+Expression+"]"+WS)
    ...
    // Original Rule: (BinaryOperator+OnError+Expression)
    ...
    // Original Rule: ("?"+WS+OnError+Expression+":"+WS+Expression)
    ...
    // Original Rule: ("("+WS+OnError+((Expression+WS+((Comma+Expression+WS))*))?+")"+WS)
    // Only Nodes: (Expression)*
    ...
    // Original Rule: ("throw"+!(IdentifierChar)+WS+OnError+Expression)
    // Only Nodes: Expression
    ...
    // Original Rule: (LambdaParameter|("("+WS+OnError+((LambdaParameter+WS+((Comma+LambdaParameter+WS))*))?+")"+WS))
    ...
    // Original Rule: (LambdaParameters+"=>"+WS+OnError+LambdaBody)
    ...
    // Original Rule: ("typeof"+!(IdentifierChar)+WS+OnError+"("+WS+OnError+TypeExpr+")"+WS)
    // Only Nodes: TypeExpr
    ...
    // Original Rule: ("nameof"+!(IdentifierChar)+WS+OnError+"("+WS+OnError+Expression+")"+WS)
    // Only Nodes: Expression
    ...
    // Original Rule: ("default"+!(IdentifierChar)+WS+OnError+(("("+WS+OnError+TypeExpr+")"+WS))?)
    // Only Nodes: (TypeExpr)?
    ...
    // Original Rule: ((Identifier+"="+WS+OnError+Expression)|Expression)
    ...
    // Original Rule: ("{"+WS+OnError+((InitializerClause+WS+((Comma+InitializerClause+WS))*))?+"}"+WS)
    ...
    // Original Rule: ("new"+!(IdentifierChar)+WS+OnError+TypeExpr+(FunctionArgs)?+(ArraySizeSpecifier)?+(Initializer)?)
    ...
    // Original Rule: ("is"+!(IdentifierChar)+WS+OnError+TypeExpr+(Identifier)?)
    // Only Nodes: (TypeExpr+(Identifier)?)
    ...
    // Original Rule: ("as"+!(IdentifierChar)+WS+OnError+TypeExpr+(Identifier)?)
    // Only Nodes: (TypeExpr+(Identifier)?)
    ...
    // Original Rule: (("{"+WS+OnError+Expression+"}"+WS)|StringLiteralChar)
    // Only Nodes: Expression
    ...
    // Original Rule: ("$"+OnError+"""+(StringInterpolationContent)*+""")
    ...
    // Original Rule: ("("+WS+OnError+((FunctionArg+WS+((Comma+FunctionArg+WS))*))?+")"+WS)
    ...
    // Original Rule: (Expression+OnError+EOS)
    // Only Nodes: Expression
    ...
    // Original Rule: ("else"+!(IdentifierChar)+WS+OnError+Statement)
    ...
    // Original Rule: ("if"+!(IdentifierChar)+WS+OnError+ParenthesizedExpression+Statement+(ElseClause)?)
    ...
    // Original Rule: ("while"+!(IdentifierChar)+WS+OnError+ParenthesizedExpression+Statement)
    ...
    // Original Rule: ("do"+!(IdentifierChar)+WS+OnError+Statement+"while"+!(IdentifierChar)+WS+ParenthesizedExpression+EOS)
    ...
    // Original Rule: ("return"+!(IdentifierChar)+WS+OnError+(Expression)?+EOS)
    // Only Nodes: (Expression)?
    ...
    // Original Rule: ("break"+!(IdentifierChar)+WS+OnError+EOS)
    // Only Nodes: 
    ...
    // Original Rule: ("yield"+!(IdentifierChar)+WS+OnError+(YieldReturn|YieldBreak))
    ...
    // Original Rule: ("continue"+!(IdentifierChar)+WS+OnError+EOS)
    // Only Nodes: 
    ...
    // Original Rule: ("{"+WS+OnError+(Statement)*+"}"+WS)
    // Only Nodes: (Statement)*
    ...
    // Original Rule: ("catch"+!(IdentifierChar)+WS+OnError+"("+WS+OnError+VarDecl+")"+WS+CompoundStatement)
    ...
    // Original Rule: ((("default"+!(IdentifierChar)+WS)|("case"+!(IdentifierChar)+WS+OnError+Expression))+Statement)
    ...
    // Original Rule: ("switch"+!(IdentifierChar)+WS+OnError+"{"+WS+OnError+(CaseClause)*+"}"+WS)
    ...
    // Original Rule: ("try"+!(IdentifierChar)+WS+OnError+CompoundStatement+(CatchClause)?+(FinallyClause)?)
    ...
    // Original Rule: ("foreach"+!(IdentifierChar)+WS+OnError+"("+WS+VarDecl+"in"+!(IdentifierChar)+WS+Expression+")"+WS+Statement)
    ...
    // Original Rule: ("for"+!(IdentifierChar)+WS+OnError+"("+WS+InitializationClause+EOS+InvariantClause+EOS+VariantClause+")"+WS+Statement)
    ...
    // Original Rule: (("="+WS+OnError+Expression))?
    // Only Nodes: (Expression)?
    ...
    // Original Rule: ("using"+!(IdentifierChar)+WS+OnError+Static+QualifiedIdentifier+EOS)
    ...
    // Original Rule: ("["+WS+OnError+((Identifier+(FunctionArgs)?+WS+((Comma+Identifier+(FunctionArgs)?+WS))*))?+"]"+WS)
    ...
    // Original Rule: (("<"+WS+OnError+((TypeParameter+WS+((Comma+TypeParameter+WS))*))?+">"+WS))?
    ...
    // Original Rule: ((((((Kind+OnError)+Identifier)+TypeParameterList)+BaseClassList)+ConstraintList)+(((("{"+WS)+OnError)+(MemberDeclaration)*)+("}"+WS)))
    ...
    // Original Rule: ("("+WS+OnError+((FunctionParameter+WS+((Comma+FunctionParameter+WS))*))?+")"+WS)
    ...
    // Original Rule: ("base"+!(IdentifierChar)+WS+OnError+ParenthesizedExpression)
    ...
    // Original Rule: ("this"+!(IdentifierChar)+WS+OnError+ParenthesizedExpression)
    // Only Nodes: ParenthesizedExpression
    ...
    // Original Rule: ("get"+!(IdentifierChar)+WS+OnError+FunctionBody)
    ...
    // Original Rule: ("set"+!(IdentifierChar)+WS+OnError+FunctionBody)
    // Only Nodes: FunctionBody
    ...
    // Original Rule: ("init"+!(IdentifierChar)+WS+OnError+FunctionBody)
    // Only Nodes: FunctionBody
    ...
    // Original Rule: (ExpressionBody|("{"+WS+OnError+PropertyClauses+"}"+WS))
    ...
    // Original Rule: (TypeExpr+"this"+!(IdentifierChar)+WS+OnError+"["+WS+OnError+FunctionParameter+"]"+WS+PropertyBody)
    ...
    // Original Rule: (TypeExpr+"operator"+!(IdentifierChar)+WS+OnError+OverloadableOperator+FunctionParameterList+FunctionBody)
    ...
    // Original Rule: ("namespace"+!(IdentifierChar)+WS+QualifiedIdentifier+"{"+WS+OnError+(TopDeclaration)*+"}"+WS)
    ...
    // Original Rule: ("["+WS+OnError+(Comma)*+"]"+WS)
    // Only Nodes: 
    ...
    // Original Rule: ("<"+WS+OnError+((TypeExpr+WS+((Comma+TypeExpr+WS))*))?+">"+WS)
    // Only Nodes: (TypeExpr)*
    ...
    // Original Rule: ("class"|"struct"|"interface"|"enum")
    // Only Nodes: 
