// DO NOT EDIT: Autogenerated file created on 2023-04-19 11:03:01 PM. 
using System;
using System.Linq;
using Parakeet;
    ...
    public static class CstNodeFactory
    {
        public static CstNode Create(ParserTree node)
        {
            switch (node.Type)
            {
                ...
                case "ParenthesizedExpr": return new CstParenthesizedExpr(node.Children.Select(Create).ToArray());
                case "Args": return new CstArgs(node.Children.Select(Create).ToArray());
                case "Invoke": return new CstInvoke(node.Children.Select(Create).ToArray());
                case "Assign": return new CstAssign(node.Children.Select(Create).ToArray());
                case "VarRef": return new CstVarRef(node.Children.Select(Create).ToArray());
                case "VarDef": return new CstVarDef(node.Children.Select(Create).ToArray());
                case "Conditional": return new CstConditional(node.Children.Select(Create).ToArray());
                case "Loop": return new CstLoop(node.Children.Select(Create).ToArray());
                case "Block": return new CstBlock(node.Children.Select(Create).ToArray());
                case "Constant": return new CstConstant(node.Children.Select(Create).ToArray());
                case "Break": return new CstBreak(node.Contents);
                case "Continue": return new CstContinue(node.Contents);
                case "Return": return new CstReturn(node.Children.Select(Create).ToArray());
                case "Noop": return new CstNoop(node.Contents);
                case "Parameters": return new CstParameters(node.Children.Select(Create).ToArray());
                case "Lambda": return new CstLambda(node.Children.Select(Create).ToArray());
                ...
                case "ValueLiteral": return new CstValueLiteral(node.Contents);
                ...
                case "InitializationClause": return new CstInitializationClause(node.Children.Select(Create).ToArray());
                case "InvariantClause": return new CstInvariantClause(node.Children.Select(Create).ToArray());
                case "VariantClause": return new CstVariantClause(node.Children.Select(Create).ToArray());
                ...
                case "DefaultValue": return new CstDefaultValue(node.Children.Select(Create).ToArray());
