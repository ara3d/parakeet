...
namespace Parakeet.Demos.Pail
{
    ...
    /// <summary>
    /// Nodes = (HexLiteral|BinaryLiteral|FloatLiteral|IntegerLiteral|StringLiteral|CharLiteral|BooleanLiteral|NullLiteral|ValueLiteral)
    /// </summary>
    public class CstLiteral : CstChoice
    {
        ...
        public CstFilter<CstValueLiteral> ValueLiteral => new CstFilter<CstValueLiteral> (Children);
    }
    ...
    /// <summary>
    /// Nodes = (VarDecl+Expression+Statement)
    /// </summary>
    ...
    /// <summary>
    /// Nodes = (TypeExpr+Identifier+(Initialization)?)
    /// </summary>
    ...
    /// <summary>
    /// Nodes = (CompoundTypeExpr|QualifiedIdentifier)
    /// </summary>
