// DO NOT EDIT: Autogenerated file created on 2023-07-11 11:55:53 AM. 
using System;
using System.Linq;
using Parakeet;
...
namespace Parakeet.Demos.Plato
{
    ...
    /// <summary>
    /// Nodes = (Identifier+TypeParameterList+InheritsList+(MemberDeclaration)*)
    /// </summary>
    ...
    /// </summary>
    public class CstModule : CstSequence
    {
        public static Rule Rule = CstNodeFactory.Grammar.Module;
        public CstModule(params CstNode[] children) : base(children) { }
        public CstFilter<CstIdentifier> Identifier => new CstFilter<CstIdentifier> (Children);
        public CstFilter<CstMethodDeclaration> MethodDeclaration => new CstFilter<CstMethodDeclaration> (Children);
    }

    /// <summary>
    /// Nodes = (Module|Concept|Type)
    /// </summary>
    public class CstTopLevelDeclaration : CstChoice
    {
        ...
        public CstFilter<CstModule> Module => new CstFilter<CstModule> (Children);
    ...
    /// <summary>
    /// Nodes = (TypeKeyword|MemberKeyword|StatementKeyword)
    /// </summary>
    public class CstSeparator : CstChoice
    {
        ...
        public CstFilter<CstMemberKeyword> MemberKeyword => new CstFilter<CstMemberKeyword> (Children);
    ...
    /// Nodes = 
    /// </summary>
    public class CstMemberKeyword : CstLeaf
    {
        public static Rule Rule = CstNodeFactory.Grammar.MemberKeyword;
        public CstMemberKeyword(string text) : base(text) { }
        // No children
    }
