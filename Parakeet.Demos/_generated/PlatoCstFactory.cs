// DO NOT EDIT: Autogenerated file created on 2023-07-11 11:55:54 AM. 
using System;
using System.Linq;
using Parakeet;
    ...
    public static class CstNodeFactory
    {
        ...
        public static CstNode Create(ParserTree node)
        {
            switch (node.Type)
            {
                ...
                case "Module": return new CstModule(node.Children.Select(Create).ToArray());
                ...
                case "MemberKeyword": return new CstMemberKeyword(node.Contents);
