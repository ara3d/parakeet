    ...
    public class CstNodeFactory : INodeFactory
    {
        ...
        public CstNode InternalCreate(ParserTreeNode node)
        {
            switch (node.Type)
            {
                ...
                case "HorizontalLine": return new CstHorizontalLine(node.Children.Select(Create).ToArray());
                ...
                case "NonEmptyTextLine": return new CstNonEmptyTextLine(node.Contents);
                ...
                case "RestOfLine": return new CstRestOfLine(node.Children.Select(Create).ToArray());
