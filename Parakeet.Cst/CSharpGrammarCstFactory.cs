// DO NOT EDIT: Autogenerated file created on 2024-03-09 10:43:08 AM. 
using System;
using System.Linq;
...
namespace Ara3D.Parakeet.Cst.CSharpGrammarNameSpace
{
    public class CstNodeFactory : INodeFactory
    {
        ...
        public Dictionary<ICSharpCstNode, ParserTreeNode> Lookup { get;} = new Dictionary<ICSharpCstNode, ParserTreeNode>();
        public ICSharpCstNode Create(ParserTreeNode node)
        {
            var r = InternalCreate(node);
            Lookup.Add(r, node);
            return r;
        }
        public ICSharpCstNode InternalCreate(ParserTreeNode node)
        {
            switch (node.Type)
            {
