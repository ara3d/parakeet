// DO NOT EDIT: Autogenerated file created on 2026-07-27 11:38:05 AM. 
using System;
using System.Linq;
...
namespace Ara3D.Parakeet.Cst.PlatoGrammarNameSpace
{
    ...
    /// <summary>
    /// Rule = Type ::= (((UniqueKeyword+WS))?+Keyword('type')+_RECOVER_+Identifier+WS+TypeParameterList+WS+ImplementsList+WS+((SumTypeBody+WS)|('{'+WS+_RECOVER_+((FieldDeclaration+WS))*+WS+'}'+WS)))
    /// Nodes = ((UniqueKeyword)?+Identifier+TypeParameterList+ImplementsList+(SumTypeBody|(FieldDeclaration)*))
    /// </summary>
