// DO NOT EDIT: Autogenerated file created on 2026-07-30 3:41:46 PM. 
using System;
using System.Linq;
...
namespace Ara3D.Parakeet.Cst.PlatoGrammarNameSpace
{
    ...
    /// <summary>
    /// Rule = Constraint ::= (Identifier+WS+TypeAnnotation+WS)
    ...
    /// <summary>
    /// Rule = MethodDeclaration ::= (Identifier+WS+FunctionParameterList+WS+_RECOVER_+TypeAnnotation+WS+FunctionBody+WS)
    ...
    /// <summary>
    /// Rule = Type ::= (((UniqueKeyword+WS))?+((PrimitiveKeyword+WS)|Keyword('type'))+_RECOVER_+Identifier+WS+TypeParameterList+WS+ImplementsList+WS+((SumTypeBody+WS)|('{'+WS+_RECOVER_+((FieldDeclaration+WS))*+WS+'}'+WS)))
    /// Nodes = ((UniqueKeyword)?+PrimitiveKeyword+Identifier+TypeParameterList+ImplementsList+(SumTypeBody|(FieldDeclaration)*))
    /// </summary>
