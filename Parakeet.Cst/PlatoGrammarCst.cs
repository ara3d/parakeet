// DO NOT EDIT: Autogenerated file created on 2026-08-01 4:06:31 PM. 
using System;
using System.Linq;
...
namespace Ara3D.Parakeet.Cst.PlatoGrammarNameSpace
{
    ...
    /// <summary>
    /// Rule = ArrayExpression ::= ('['+WS+_TRUE_+(((Expression+WS+WS+((Comma+Expression+WS+WS))*)+(Comma)?))?+WS+']'+WS)
    /// Nodes = (Expression)*
    /// </summary>
    ...
    /// <summary>
    /// Rule = BracedTokenGroup ::= ('{'+WS+_TRUE_+Token+WS+'}'+WS)
    ...
    /// <summary>
    /// Rule = BracketedTokenGroup ::= ('['+WS+_TRUE_+Token+WS+']'+WS)
    /// Nodes = ((TypeKeyword+TypeName)|(FieldName+TypeName+(TypeParametersToken)?)|(FunctionName+ParameterName+TypeName+(TypeParametersToken)?+((ParameterName+TypeName+(TypeParametersToken)?))*+((TypeName+(TypeParametersToken)?))?)|Separator|Delimiter|Operator|Identifier|HexLiteral|BinaryLiteral|FloatLiteral|IntegerLiteral|StringLiteral|CharLiteral|BooleanLiteral|NullLiteral|Unknown)
    /// </summary>
    ...
    /// <summary>
    /// Rule = CaseDeclaration ::= (Identifier+WS+((FunctionParameterList+WS))?)
    /// Nodes = (Identifier+(FunctionParameterList)?)
    /// </summary>
    public class CstCaseDeclaration : CstNodeSequence, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.CaseDeclaration;
        public CstCaseDeclaration(ILocation location, params CstNode[] children) : base(location, children) { }
        public CstNodeFilter<CstIdentifier> Identifier => new CstNodeFilter<CstIdentifier> (Children);
    ...
    /// <summary>
    /// Rule = CompoundOrSimpleTypeExpr ::= ((CompoundTypeExpr+WS)|(SimpleTypeExpr+WS)|(TypeVar+WS))
    ...
    /// <summary>
    /// Rule = Concept ::= ((Keyword('concept')|Keyword('interface'))+_RECOVER_+Identifier+WS+TypeParameterList+WS+ConstraintList+WS+InheritsList+WS+'{'+WS+_RECOVER_+((MethodDeclaration+WS))*+WS+'}'+WS)
    ...
    /// <summary>
    /// Rule = Constraint ::= (((TypeVar+WS)|(Identifier+WS))+TypeAnnotation+WS)
    /// Nodes = ((TypeVar|Identifier)+TypeAnnotation)
    /// </summary>
    ...
    /// <summary>
    /// Rule = ConstraintList ::= ((Keyword('where')+_RECOVER_+(((Constraint+WS+WS+((Comma+Constraint+WS+WS))*)+(Comma)?))?))?
    /// Nodes = (Constraint)*
    /// </summary>
    ...
    /// <summary>
    /// Rule = ExpressionBody ::= (Symbol('=>')+_RECOVER_+Expression+WS+EOS)
    /// Nodes = Expression
    /// </summary>
    ...
    /// <summary>
    /// Rule = FieldDeclaration ::= (Identifier+WS+Symbol(':')+TypeExpr+WS+EOS)
    ...
    /// <summary>
    /// Rule = File ::= (WS+((TopLevelDeclaration+WS))*+_RECOVER_+EndOfInput)
    ...
    /// <summary>
    /// Rule = FunctionParameter ::= (Identifier+WS+TypeAnnotation+WS)
    ...
    /// <summary>
    /// Rule = ImplementsList ::= ((Keyword('implements')+_RECOVER_+(((TypeExpr+WS+WS+((Comma+TypeExpr+WS+WS))*)+(Comma)?))?))?
    /// Nodes = (TypeExpr)*
    /// </summary>
    ...
    /// <summary>
    /// Rule = InheritsList ::= ((Keyword('inherits')+_RECOVER_+(((TypeExpr+WS+WS+((Comma+TypeExpr+WS+WS))*)+(Comma)?))?))?
    /// Nodes = (TypeExpr)*
    /// </summary>
    ...
    /// </summary>
    public class CstInitializerClause : CstNodeChoice, IPlatoCstNode
    {
    ...
    /// <summary>
    /// Rule = LeafExpression ::= ((LambdaExpr+WS)|(CastExpression+WS)|(ParenthesizedExpression+WS)|(ArrayExpression+WS)|(ThrowExpression+WS)|(Literal+WS)|(TypeOf+WS)|(NameOf+WS)|(Default+WS)|(NewOperation+WS)|(StringInterpolation+WS)|(MatchExpression+WS)|(Identifier+WS))
    /// Nodes = (LambdaExpr|CastExpression|ParenthesizedExpression|ArrayExpression|ThrowExpression|Literal|TypeOf|NameOf|Default|NewOperation|StringInterpolation|MatchExpression|Identifier)
    /// </summary>
    public class CstLeafExpression : CstNodeChoice, IPlatoCstNode
    {
        ...
        public CstNodeFilter<CstMatchExpression> MatchExpression => new CstNodeFilter<CstMatchExpression> (Children);
        public CstNodeFilter<CstIdentifier> Identifier => new CstNodeFilter<CstIdentifier> (Children);
    }

    /// <summary>
    /// Rule = Library ::= (Keyword('library')+_RECOVER_+Identifier+WS+'{'+WS+_RECOVER_+((MethodDeclaration+WS))*+WS+'}'+WS)
    ...
    /// <summary>
    /// Rule = MatchArm ::= (Identifier+WS+((MatchArmBinders+WS))?+Symbol('=>')+_RECOVER_+Expression+WS+EOS)
    /// Nodes = (Identifier+(MatchArmBinders)?+Expression)
    /// </summary>
    public class CstMatchArm : CstNodeSequence, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.MatchArm;
        public CstMatchArm(ILocation location, params CstNode[] children) : base(location, children) { }
        public CstNodeFilter<CstIdentifier> Identifier => new CstNodeFilter<CstIdentifier> (Children);
        public CstNodeFilter<CstMatchArmBinders> MatchArmBinders => new CstNodeFilter<CstMatchArmBinders> (Children);
        public CstNodeFilter<CstExpression> Expression => new CstNodeFilter<CstExpression> (Children);
    }

    /// <summary>
    /// Rule = MatchArmBinders ::= ('('+WS+_TRUE_+(((Identifier+WS+WS+((Comma+Identifier+WS+WS))*)+(Comma)?))?+WS+')'+WS)
    /// Nodes = (Identifier)*
    /// </summary>
    public class CstMatchArmBinders : CstNode, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.MatchArmBinders;
        public CstMatchArmBinders(ILocation location, params CstNode[] children) : base(location, children) { }
        public CstNodeFilter<CstIdentifier> Identifier => new CstNodeFilter<CstIdentifier> (Children);
    }

    /// <summary>
    /// Rule = MatchExpression ::= (Keyword('match')+_RECOVER_+ParenthesizedExpression+WS+'{'+WS+_RECOVER_+((MatchArm+WS))*+WS+'}'+WS)
    /// Nodes = (ParenthesizedExpression+(MatchArm)*)
    /// </summary>
    public class CstMatchExpression : CstNodeSequence, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.MatchExpression;
        public CstMatchExpression(ILocation location, params CstNode[] children) : base(location, children) { }
        public CstNodeFilter<CstParenthesizedExpression> ParenthesizedExpression => new CstNodeFilter<CstParenthesizedExpression> (Children);
        public CstNodeFilter<CstMatchArm> MatchArm => new CstNodeFilter<CstMatchArm> (Children);
    }
    ...
    /// <summary>
    /// Rule = MethodDeclaration ::= (Identifier+WS+FunctionParameterList+WS+_RECOVER_+TypeAnnotation+WS+ConstraintList+WS+FunctionBody+WS)
    /// Nodes = (Identifier+FunctionParameterList+TypeAnnotation+ConstraintList+FunctionBody)
    /// </summary>
    ...
    /// <summary>
    /// Rule = ParenthesizedTokenGroup ::= ('('+WS+_TRUE_+Token+WS+')'+WS)
    /// Nodes = ((TypeKeyword+TypeName)|(FieldName+TypeName+(TypeParametersToken)?)|(FunctionName+ParameterName+TypeName+(TypeParametersToken)?+((ParameterName+TypeName+(TypeParametersToken)?))*+((TypeName+(TypeParametersToken)?))?)|Separator|Delimiter|Operator|Identifier|HexLiteral|BinaryLiteral|FloatLiteral|IntegerLiteral|StringLiteral|CharLiteral|BooleanLiteral|NullLiteral|Unknown)
    /// </summary>
    ...
    /// <summary>
    /// Rule = PostfixOperator ::= (Symbol('++')|Symbol('--')|(MemberAccess+WS)|(ConditionalMemberAccess+WS)|(FunctionArgs+WS)|(Indexer+WS)|(TernaryOperation+WS)|(BinaryOperation+WS)|(IsOperation+WS)|(AsOperation+WS))
    ...
    /// <summary>
    /// Rule = PrimitiveKeyword ::= ("primitive"+!(IdentifierChar)+WS)
    /// Nodes = 
    /// </summary>
    public class CstPrimitiveKeyword : CstNodeLeaf, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.PrimitiveKeyword;
        public CstPrimitiveKeyword(ILocation location, string text) : base(location, text) { }
    }
    ...
    /// <summary>
    /// Rule = SumTypeBody ::= (Symbol('=')+_RECOVER_+CaseDeclaration+WS+((Symbol('|')+CaseDeclaration+WS))*+EOS)
    /// Nodes = (CaseDeclaration)+
    /// </summary>
    public class CstSumTypeBody : CstNode, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.SumTypeBody;
        public CstSumTypeBody(ILocation location, params CstNode[] children) : base(location, children) { }
        public CstNodeFilter<CstCaseDeclaration> CaseDeclaration => new CstNodeFilter<CstCaseDeclaration> (Children);
    }
    ...
    /// <summary>
    /// Rule = TokenGroup ::= (((BracedTokenGroup+WS)|(BracketedTokenGroup+WS)|(ParenthesizedTokenGroup+WS)|Token))+
    ...
    /// <summary>
    /// Rule = TopLevelDeclaration ::= ((Library+WS)|(Concept+WS)|(Type+WS))
    ...
    /// <summary>
    /// Rule = Type ::= (((UniqueKeyword+WS))?+((PrimitiveKeyword+WS)|Keyword('type'))+_RECOVER_+Identifier+WS+TypeParameterList+WS+ConstraintList+WS+ImplementsList+WS+((SumTypeBody+WS)|('{'+WS+_RECOVER_+((FieldDeclaration+WS))*+WS+'}'+WS)))
    /// Nodes = ((UniqueKeyword)?+PrimitiveKeyword+Identifier+TypeParameterList+ConstraintList+ImplementsList+(SumTypeBody|(FieldDeclaration)*))
    /// </summary>
    public class CstType : CstNodeSequence, IPlatoCstNode
    {
        ...
        public CstNodeFilter<CstUniqueKeyword> UniqueKeyword => new CstNodeFilter<CstUniqueKeyword> (Children);
        public CstNodeFilter<CstPrimitiveKeyword> PrimitiveKeyword => new CstNodeFilter<CstPrimitiveKeyword> (Children);
        public CstNodeFilter<CstIdentifier> Identifier => new CstNodeFilter<CstIdentifier> (Children);
        public CstNodeFilter<CstTypeParameterList> TypeParameterList => new CstNodeFilter<CstTypeParameterList> (Children);
        public CstNodeFilter<CstConstraintList> ConstraintList => new CstNodeFilter<CstConstraintList> (Children);
        public CstNodeFilter<CstImplementsList> ImplementsList => new CstNodeFilter<CstImplementsList> (Children);
        public CstNodeFilter<CstSumTypeBody> SumTypeBody => new CstNodeFilter<CstSumTypeBody> (Children);
    ...
    /// <summary>
    /// Rule = TypeParametersToken ::= ('<'+CommentOrSpaces+TypeParameterToken+WS+CommentOrSpaces+((','+CommentOrSpaces+TypeParameterToken+WS))*+'>'+CommentOrSpaces)
    ...
    /// <summary>
    /// Rule = TypeParameterToken ::= (Identifier+WS+CommentOrSpaces+TypeAnnotationToken)
    /// Nodes = Identifier
    /// </summary>
    ...
    /// <summary>
    /// Rule = UniqueKeyword ::= ("unique"+!(IdentifierChar)+WS)
    /// Nodes = 
    /// </summary>
    public class CstUniqueKeyword : CstNodeLeaf, IPlatoCstNode
    {
        public static Rule Rule = CstNodeFactory.StaticGrammar.UniqueKeyword;
        public CstUniqueKeyword(ILocation location, string text) : base(location, text) { }
    }
