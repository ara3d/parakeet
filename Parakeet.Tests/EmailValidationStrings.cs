...
public static class EmailValidationStrings
{
        public static readonly string[] ValidAddresses = {
            "\"Abc\\@def\"@example.com",
        ...
        public static readonly string[] InvalidAddresses = {
            string.Empty,
            "invalid",
            "invalid@",
            "invalid @",
        ...
        public static readonly string[] ValidInternationalAddresses = {
            "伊昭傑@郵件.商務", // Chinese
        ...
        public static readonly string[] InvalidInternationalAddresses = {
